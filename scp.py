# scp.py
"""
An SCP utility that works with paramiko.

See my fork:  https://github.com/randomInteger/scp.py

I am not the original author of the code in this file, follow
my fork for the original work, author, license, etc...
"""
